# Generated by Django 2.2.6 on 2019-12-01 15:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('network_consult', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='network_consult', to=settings.AUTH_USER_MODEL, verbose_name='咨询师')),
            ],
        ),
        migrations.CreateModel(
            name='Department',
