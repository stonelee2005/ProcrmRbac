...
class Customer(models.Model):
    ...
    sex = models.CharField('性别', max_length=16, default='male', blank=True, null=True, choices=sex_type)
    birthday = models.DateField('出生日期', default=None, blank=True, null=True, help_text='格式yyyy-mm-dd')
